 ...
 */
public class ContentCarouselAdapter extends BaseSelectableListAdapter<MediaContent>
{
	public ContentCarouselAdapter(List<MediaContent> items, OnListItemClickListener<MediaContent> listener)
	{
